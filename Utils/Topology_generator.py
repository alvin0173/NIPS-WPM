...
def create_topology_list(args, path):
    world_size = args.world_size
    density = 0.4 if args.topology == 'random' else 0.1
    topology_list = []
    for _ in range(500):
        topology_list.append(creat_topology(world_size, density, 1))
    np.save(path, topology_list)
